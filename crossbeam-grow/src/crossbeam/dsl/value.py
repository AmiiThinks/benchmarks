...
class LibraryValue(Value):
  """A Value to grow the library. Just an OperationValue with constant weight"""

  def __init__(self, value, operation, arg_values, weight):
    super(LibraryValue, self).__init__(value)
