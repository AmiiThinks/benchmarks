...
public:
	...
	const uint64_t operator[](std::size_t idx) const { return Get(idx); }
	void FillMax();
	void Clear();
	...
	uint64_t SetAndTest(uint64_t index, uint64_t val);
	bool SetIf(uint64_t index, uint64_t val, uint64_t equalToThisValue);
	void Or(uint64_t index, uint64_t val);
...
template <uint64_t numBits>
bool NBitArray<numBits>::SetIf(uint64_t index, uint64_t val, uint64_t equalToThisValue)
{
	uint64_t startingBit = index*numBits;
	uint64_t offset1 = startingBit/64;
	uint64_t bitOffset1 = startingBit&0x3F; // same as mod 64
...
template <uint64_t numBits>
uint64_t NBitArray<numBits>::SetAndTest(uint64_t index, uint64_t val)
{
	uint64_t startingBit = index*numBits;
	uint64_t offset1 = startingBit/64;
	uint64_t bitOffset1 = startingBit&0x3F; // same as mod 64
...
template <uint64_t numBits>
void NBitArray<numBits>::Or(uint64_t index, uint64_t val)
{
	uint64_t startingBit = index*numBits;
	uint64_t offset1 = startingBit/64;
	uint64_t bitOffset1 = startingBit&0x3F; // same as mod 64
	...
	uint64_t bitMask1 = (1ull<<bitCount1)-1;
	uint64_t bitMask2 = (1ull<<bitCount2)-1;
	mem[offset1] = (mem[offset1]) | ((val&bitMask1)<<bitOffset1);
	mem[offset1+1] = (mem[offset1+1]) | ((val>>bitCount1)&bitMask2);
	//	uint64_t result = (mem[offset1]>>bitOffset1)&bitMask1;
...
template <>
void NBitArray<2>::Or(uint64_t index, uint64_t val);
