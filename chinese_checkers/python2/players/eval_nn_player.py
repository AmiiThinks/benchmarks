...
class NNPlayer():
    def __init__(self, trained_model_params_path, mod): 
        self._name = "nn_player"
        self.C = 1.3
        self.trained_model_params_path = trained_model_params_path
    ...
    def _load_trained_model(self, mod):
        if mod > 0:
            path = os.path.join(self.trained_model_params_path)
