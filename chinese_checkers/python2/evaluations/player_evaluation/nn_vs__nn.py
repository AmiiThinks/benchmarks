...
if __name__ == "__main__":
    ...
    for i in range(len(eval_mods)-1):
        nnp1 = nnp.NNPlayer(i)
        nnp2 = nnp.NNPlayer(i+1)

        p1 = mcts.MCTS(cc, nnp1) # nn player 1
        p2 = mcts.MCTS(cc, nnp2) # nn player 2
        players_list = [[p1, p2]]
        players_list_names= [['nn_{}'.format(i), 'nn_{}'.format(i+1)]]
        outcomes = []
