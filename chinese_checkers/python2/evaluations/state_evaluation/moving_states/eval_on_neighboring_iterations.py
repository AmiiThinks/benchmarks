...
def make_accuracy_graph(result):
    ...
    plt.savefig("../../results/accuracy_on_neighboring_iteration.png")
    plt.close()
    return
...
if __name__ == "__main__":
    ...
    #     global_data.update(n_states[str(iteration)])
    #     if iteration % 10 == 0:
    ...
    # with open('neiboring_evaluation_result.pkl', 'wb') as fp:
    #     pickle.dump(result, fp)

    result = pickle.load(open('neiboring_evaluation_result.pkl', 'rb'))
